...
EXAMPLE
Consumer, client, user, acquirer, buyer, or purchaser.
...
EXAMPLE 
A configuration management system used to control software elements during software development.
...
[SOURCE: ISO 26262‐1:2011, modified, NOTE to entry added.]
...
EXAMPLE
Hardware, software, data, humans, processes (e.g., processes for providing service to users), procedures (e.g., operator instructions), facilities, materials, and naturally occurring entities or any combination.
...
NOTE
Each constituent system is a useful system by itself, having its own management, goals, and resources, but coordinates within the SoS to provide the unique capability of the SoS.
...
[SOURCE: ISO/IEC 25010:2011, modified, NOTE to entry added.]
...
[SOURCE: ISO 9000:2015, modified, NOTE to entry added.]
